...
function Hero() {
  ...
  const handleEquipmentsBtnClick = () => {
    navigate("/equipments");
  };
  ...
  useEffect(() => {
    ...
    const experienceEndValue = 1; // Change this to your desired end value for years of experience
    const endValue = 1000;
    const doctorEndValue = 7; // Change this to your desired end value for doctors
      ...
      <div className="hero-section">
        <div className="text-section">
          ...
          <button
            ...
            style={{ marginRight: "15px" }}
            type="button"
            onClick={handleEquipmentsBtnClick}
          >
            <FontAwesomeIcon icon={faCalendarCheck} /> Get Medical Equipments
          </button>
